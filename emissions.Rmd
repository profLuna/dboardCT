...
Concentrations of hazardous air pollutants and associated risks are highest in the eastern half of the state and around the urbanized areas in central and western Connecticut. Limited English speaking households and people of color are by far the most exposed to higher levels of air pollutants and are living in close proximity to high traffic corridors.
...
leaflet(width = "100%") %>% 
  ...
  addPolygons(data = ct_towns_simple,
              ...
              color = "gray",
              fillOpacity = 0,
              label=~NAME, popup=~NAMELSAD10, group='muni') %>% 
