...
* 45% of the state’s residents do not have physical access to any form of public transit. 
* Only 30% of the population lives within a reasonable walking distance of a bus stop. 
* The places that have the least access to public transit, the least frequent service, lower than average walkability, and the highest transportation cost burdens are all the less urban parts of the state, particularly for persons over 64 years of age.
